...
export interface PatternAnalysisResult {
  ...
  // LLM-specific: actionable items ready for execution
  actionItems: ActionItem[];
}

// This is the key structure for LLM consumption
export interface ActionItem {
  ...
  steps: Array<{
    ...
    code?: {
      ...
      target: string; // line number or code snippet to find
      content: string; // new content
    };
  }>;
  acceptPrompt: string; // What to ask user for confirmation
}
